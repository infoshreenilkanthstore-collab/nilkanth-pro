...
export default function ProductCard({ product }) {
    ...
    return (
        <>
            <div className="group/card flex flex-col relative w-full bg-white h-full overflow-hidden hover:shadow-lg transition">
                ...
                <div className="relative aspect-square w-full bg-gray-50 overflow-hidden">
                    ...
                    <button
                        ...
                        className="absolute top-3 right-3 z-10 p-2 bg-white/80 hover:bg-white rounded-full shadow-md text-[#700b10] transition-all duration-300 transform hover:scale-110 active:scale-95"
                    >
                        <Heart
                            className={`w-4 h-4 md:w-5 md:h-5 transition-colors ${isInWishlist(p.id) ? "fill-[#700b10]" : ""
                                }`}
                        />
                    </button>
                ...
                {/* DETAILS */}
                <div className="flex flex-col flex-1 p-3 md:p-4 md:gap-1">
                    <p className="text-[9px] md:text-[10px] text-gray-400 font-bold uppercase tracking-[0.1em] mb-1">NILKANTH STORE</p>

                    {/* Title - Multi-segment Support */}
                    <div className="min-h-[2.5rem] flex flex-col justify-center">

                        <a href={`/products/${p.handle}`}>
                            <h2 className="text-[10px] md:text-sm font-bold text-gray-900 hover:text-[#700b10] line-clamp-2 transition-colors">
                                {p.title}
                            </h2>
                        </a>
                    ...
                    <div className="flex flex-col mt-2 mb-3">
                        <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5">
                            <span className="text-[#700b10] text-lg font-black leading-none">
                        ...
                        {allVariants.length > 1 && (
                            <span className="text-[10px] text-gray-500 font-medium italic mt-1">Weight :&nbsp;
            ...
            {/* MODAL */}
            <ProductModal isOpen={isOpen} onClose={() => setIsOpen(false)} product={p} />
        </>
    );
}
